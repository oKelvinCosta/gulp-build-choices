import{onMounted}from"https://unpkg.com/vue@3/dist/vue.esm-browser.js";export default{data(){return{items:[{id:1,img:"src/img/aula/image 14app.jpg",alt:"Aplicativo Macros",html:`
            <p><b>Perfil</b></p>
            <br>
            <p>
            ...
            `},{id:2,img:"src/img/aula/image 15app.jpg",alt:"Aplicativo Macros",html:`
            <p><b>Perfil</b></p>
            <br>
            <p>
            ...
            `},{id:3,img:"src/img/aula/image 16app.jpg",alt:"Aplicativo Macros",html:`
            ...
            `},{id:4,img:"src/img/aula/image 18app.jpg",alt:"Aplicativo Macros",html:`
            <p><b>Objetivo</b></p>
            <br>
            <p>
            ...
            `},{id:5,img:"src/img/aula/image 19app.jpg",alt:"Aplicativo Macros",html:`
            <p><b>Continuando…</b></p>
            <br>
            <p>
...
Nesta aba, você conseguirá verificar a quantidade de nutrientes consumidos, assim como inserir seus alimentos.
            ...
            `},{id:6,img:"src/img/aula/image 20app.jpg",alt:"Aplicativo Macros",html:`
            ...
            `},{id:7,img:"src/img/aula/image 21app.jpg",alt:"Aplicativo Macros",html:`
            ...
            `},{id:8,img:"src/img/aula/image 22app.jpg",alt:"Aplicativo Macros",html:`
            ...
            `},{id:9,img:"src/img/aula/image 23app.jpg",alt:"Aplicativo Macros",html:`
            <p><b>Inserindo o alimento…</b></p>
            <br>
            <p>
            ...
            `},{id:10,img:"src/img/aula/image 24app.jpg",alt:"Aplicativo Macros",html:`
            <p><b>Inserindo o alimento…</b></p>
            <br>
            <p>
            ...
            `},{id:11,img:"src/img/aula/image 25app.jpg",alt:"Aplicativo Macros",html:`
            <p><b>Inserindo o alimento…</b></p>
            <br>
            <p>
            ...
            `},{id:12,img:"src/img/aula/image 26app.jpg",alt:"Aplicativo Macros",html:`
            ...
            `}],instances:null,qtdSlides:0,ordem:0}},methods:{next(){document.querySelector(".previous").style.display="flex",this.ordem++,this.ordem>=this.qtdSlides&&(this.ordem=0,document.querySelector(".previous").style.display="none"),this.instances[0].next(),console.log(this.ordem)},previous(){console.log(this.ordem),this.ordem--,this.ordem<0?(this.ordem=0,console.log(123),document.querySelector(".previous").style.display="none"):0===this.ordem?(this.instances[0].prev(),document.querySelector(".previous").style.display="none"):this.instances[0].prev(),console.log(this.ordem)}},mounted(){var e=document.querySelectorAll(".carousel");this.instances=M.Carousel.init(e,{fullWidth:!0,indicators:!0,shift:20}),this.qtdSlides=this.instances[0].count,document.querySelector(".previous").style.display="none"},template:`
    <!-- Carousel -->
